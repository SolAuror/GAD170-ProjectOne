...
//     version 1.18.0
//     from Assets/PartyTaxes/Input/SimpleControls.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/PartyTaxes/Input/SimpleControls.inputactions".
/// </summary>
/// <remarks>
...
public partial class @SimpleControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""30289c97-4b2d-4005-840c-f1a0a6bbf897"",
    ...
    ~@SimpleControls()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, SimpleControls.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, SimpleControls.UI.Disable() has not been called.");
    }
